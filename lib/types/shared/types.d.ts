...
export type SystemVariableName = 'cur_date' | 'cur_time' | 'cur_datetime' | 'model_id' | 'model_name' | 'timezone' | 'locale' | 'user_name' | 'assistant_name' | 'assistant_tags' | 'workspace' | 'chat_count' | 'last_chat_time' | 'elapsed_since_last';
/** 系统提示词配置。 */
